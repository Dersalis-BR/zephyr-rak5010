...
#define MODEM_CMD_HANDLER_MAX_PARAM_COUNT 6
#define MODEM_CMD_HANDLER_MAX_SIZE 		  200
...
#define MQTT_HANDLER_PREFIX "+QMT"

typedef void  (* notify_handler)(char *data, u16_t len);
...
struct modem_cmd_handler_data {
	...
	bool notify_any_data;
	
	notify_handler mqtt_handler;
